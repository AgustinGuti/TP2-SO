...
; Use this to allocate memory in data segment, outside the stack
section .bss
    align 64
    screenBuffer resb 1024*3*100  ;"Arbitrary" value... with a bpp of 24 is enough to hold 100 lines 
